...
class plotter:
    def __init__(self, _aggr, _depl, _Rss, _S_0,
                ...
                _N=200, _Rmax=2, _Rmin=0, _Smax=3, _Smin=0, _title='test'):
        ...
        self.data_dR_dt_R_lines = ColumnDataSource(data=dict(R_ss_y=[R_ss, R_ss], dR_dt_ss_y=[0, self.depletion(R_ss, self.kvalues)]))#y parallel
        ...
        self.data_S_R_lines = ColumnDataSource(data=dict(R_ss_y=[0, R_ss], S_ss_y=[self.S, self.S], #y and x parallel
                                                    R_ss_x=[R_ss, R_ss], S_ss_x=[0, self.S]))
    ...
    def create_figure(self):
        ...
        plot_dR_dt.line('R', 'dR_dt_depl', source=self.data_dR_dt_R, line_width=3, line_alpha=0.6)
        plot_dR_dt.line('R', 'dR_dt_aggr', source=self.data_dR_dt_R, line_width=3, line_alpha=0.6, color='red')
        ...
        plot_R_S.line('S', 'R', source=self.data_S_R, line_width=3, line_alpha=0.6)
        plot_R_S.line('S_ss_y', 'R_ss_y', source=self.data_S_R_lines, line_width=3, line_alpha=0.6, color='blue', line_dash='4 4')
    ...
    def update_data(self, attrname, old, new):
        ...
        self.data_dR_dt_R_lines.data = dict(R_ss_y=[R_ss, R_ss], dR_dt_ss_y=[0, self.depletion(R_ss, self.kvalues)])#y parallel
